/**
 * @file SAMD21_getting_started.ino
 * @brief A simple example to demonstrate the basic functionality of the XDuinoRails_MotorDriver library on a SAMD21 board.
 *
...
const int MOTOR_PWM_A_PIN = A0;  // Connect to BDR-6133 InA
const int MOTOR_PWM_B_PIN = A1;  // Connect to BDR-6133 InB
...
void setup() {
  ...
  Serial.println("Motor Driver SAMD21 Getting Started Example");
